...
class NotificationController extends Controller
{
 ...
 // notification function here
    ...
    public function createNotification(NotificationRequest $request){
        $request->validate([
            'notification_file' => 'nullable|mimes:jpeg,png,jpg,gif,pdf|max:2048',
 ...
 // downloads function here
    ...
    public function createStudentAchievements(Request $request){
        ...
        $studentAchievements->publication_date = $request->publication_date;
        $studentAchievements->end_date = $request->end_date;
