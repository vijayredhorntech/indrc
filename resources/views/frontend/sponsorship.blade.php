                ...
                <div class="title-column col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="sponsors-outer">
                        ...
                        <div class="row">
                            ...
                            <div class="client-block col-lg-3 col-md-6 col-sm-12 wow fadeInRight">
                                <figure class="image-box"><a href="javascript:void(0)"><img src="{{asset('assets/front/images/clients/helix.png')}}" alt=""></a></figure>
                            </div>
                            <div class="client-block col-lg-3 col-md-6 col-sm-12 wow fadeInRight">
                                <figure class="image-box"><a href="javascript:void(0)"><img src="{{asset('assets/front/images/clients/gauri.png')}}" alt=""></a></figure>
                            </div>
                        </div>
