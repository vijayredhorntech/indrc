...
@section('content')
    ...
    <form class="mb-9 {{$formData['type']==='show'?'d-none':''}}" id="addNewAchievement" action="{{$formData['url']}}" method="{{$formData['method']}}" enctype="multipart/form-data">
        ...
        <div class="row g-3 flex-between-end mb-5">
            <div class="col-auto">
                <h2 class="mb-2">Add New Opportunities</h2>
            </div>
            <div class="col-auto">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="row gx-3">
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-12">
                                        <div class="mb-4">
                                            <h5 class="mb-2 text-body-highlight">Publication Date</h5>
                                            <input class="form-control mb-xl-3" name="publication_date" type="date"
                                                   value="{{ old('publication_date', isset($achievement) && $achievement->publication_date ? \Carbon\Carbon::parse($achievement->publication_date)->format('Y-m-d') : null) }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-xl-12">
                                        <div class="mb-4">
                                            <h5 class="mb-2 text-body-highlight">End Date</h5>
                                            <input class="form-control mb-xl-3" name="end_date" type="date"
                                                   value="{{ old('end_date', isset($achievement) && $achievement->end_date ? \Carbon\Carbon::parse($achievement->end_date)->format('Y-m-d') : null) }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-xl-12">
                                        <div class="mb-4">
                ...
                <div class="table-responsive scrollbar mx-n1 px-1">
                    <table class="table table-sm fs-9 mb-0">
                        ...
                        <tr>
                            ...
                            <th class="sort align-middle ps-8" scope="col" data-sort="customer" style="width:15%;">
                                DESCRIPTION
                            </th>
                            <th class="sort align-middle ps-8" scope="col" data-sort="customer" style="width:12%;">
                                IMAGE
                            </th>
                            <th class="sort align-middle ps-8" scope="col" data-sort="customer" style="width:12%;">
                                PUB DATE
                            ...
                            <th class="sort align-middle text-end pe-0" scope="col" data-sort="date" style="width:8%">
                                ACTION
                            </th>
                        </tr>
                        </thead>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="customer align-middle white-space-nowrap ps-8">
                                    <h6 class="mb-0  text-body">
                                        {{ \Illuminate\Support\Str::words($achievement->title, 4, '...') }}
                                    </h6>
                                </td>
                                <td class="customer align-middle white-space-nowrap ps-8">
                                    <h6 class="mb-0  text-body">
                                        {{ \Illuminate\Support\Str::words($achievement->description, 4, '...') }}
                                    </h6>
                                </td>
                                <td class="customer align-middle white-space-nowrap ps-8">
                                ...
                                <td class="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">
                                    {{ $achievement->publication_date ? \Carbon\Carbon::parse($achievement->publication_date)->format('d/m/Y') : '-' }}
                                </td>
                                <td class="delivery_type align-middle white-space-nowrap text-body fs-9 text-start">
                                    {{ $achievement->end_date ? \Carbon\Carbon::parse($achievement->end_date)->format('d/m/Y') : '-' }}
                                </td>
