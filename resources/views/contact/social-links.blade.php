                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <select class="form-control mb-5" name="icon">
                            ...
                            <option value="google-scholar" {{ isset($socialLink->icon) && $socialLink->icon ? 'selected' : ''}}>Google Scholar</option>
                            <option value="researchgate" {{ isset($socialLink->icon) && $socialLink->icon ? 'selected' : ''}}>Research Gate</option>
                        </select>
