<div class="p-6 bg-white rounded-lg shadow-md">
    ...
    <form wire:submit.prevent="saveMenu" class=" row">
        ...
        <div id="fileUpload" class="d-none d-flex flex-column col-4 mb-4">
            <label for="file" class="block text-sm font-medium text-gray-700">Upload File:</label>
            <input type="file" id="file" wire:model="file" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateLinkFields() {
            ...
            else if (linkTypeSelect.value === 'file') {
                manualLinkDiv.classList.add('d-none');
                pageLinkDiv.classList.add('d-none');
