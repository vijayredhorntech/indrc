    ...
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{route('dashboard')}}">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        <img alt="phoenix" src="{{asset('assets/front/images/logo.png')}}" width="80"/>
                        <div style="display: flex; flex-direction: column; align-items: start; justify-content: center">
                            <span style="margin-left: 5px; font-weight: 900; font-size: 18px">IIT ROORKEE</span>
                            <span style="margin-left: 5px; font-weight: 600; font-size: 14px">Department of Biosciences and Bioengineering</span>
                        </div>
                    </div>
                </div>
            </a>
