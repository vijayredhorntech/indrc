...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('assets/front/images/whiteLogo.png')}}">
    <link rel="apple-touch-icon"  href="{{asset('assets/front/images/whiteLogo.png')}}">
                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                ...
                                <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                                    <h3 class="mb-3 text-body-emphasis fs-7">IIT ROORKEE</h3>
                                    <h5 class="mb-3 text-body-emphasis fs-9">Department of Biosciences and Bioengineering</h5>
                                    <p class="text-body-tertiary">"IIT Roorkee's Department of Biosciences and Bioengineering is a leading center for interdisciplinary research and education, fostering innovation in biotechnology, molecular biology, and biomedical engineering. "</p>
